  ...
  const toggle = (id) => {
    ...
    return (
      ...
      <Accordion open={open} toggle={toggle} className='AccordionStyling'>
        ...
        <AccordionItem >
          <AccordionHeader targetId="1" className='AccordionHeaderStyling'>Armand Arslanian </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="2" className='AccordionHeaderStyling'>Arthur Loefstedt </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="3" className='AccordionHeaderStyling'>Salvador Fierro </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="4" className='AccordionHeaderStyling'>Lionel Verrier </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="5" className='AccordionHeaderStylingSteph'>Stephanie Kwong </AccordionHeader>
