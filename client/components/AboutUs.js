  ...
  const toggle = (id) => {
    ...
    return (
      ...
      <Accordion open={open} toggle={toggle}>
        ...
        <AccordionItem>
          <AccordionHeader targetId="1">Armand Arslanian: </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="2">Arthur Loefstedt: </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="3">Salvador Fierro: </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="4">Lionel Verrier: </AccordionHeader>
        ...
        <AccordionItem>
          <AccordionHeader targetId="5">Stephanie Kwong: </AccordionHeader>
